...
export default function UserAdvertisementCard({item}) {
  return (
    <div className='w-full h-[441px] rounded-2xl relative'>
      <div className='absolute top-3 right-3  flex'>
        <div className='rounded-full bg-red-700 p-2 hover:scale-110 transition-all cursor-pointer mr-2'>
          <MdOutlineEdit color='white' size={20}/>
        </div>
        <div className='rounded-full bg-red-700 p-2 hover:scale-110 transition-all cursor-pointer'>
