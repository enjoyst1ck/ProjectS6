...
export default function EditPage() {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      console.log(res);
      alert('Your advertisement has been successfully edited. You will be redirected to the user panel');
      ...
      <div className='w-[75%] mx-auto flex flex-col mb-20'>
        ...
        <div className='w-full flex flex-col mt-24'>
          <div className='flex flex-col'>
            <span className='font-bold text-4xl'>Edit advertisement</span>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className='flex flex-row justify-between mt-10'>
              <div className='flex flex-col'>
                ...
                <div className='flex'>
                  <div className='mr-5 w-64 h-40 items-center flex justify-center'>
                    <input defaultChecked={data && data.isForSell === true ? true : false} {...register("isForSell", { required: "Please select if the property is for sell or rent" })} type="radio" id="isSell-true" name="isForSell" value="true" className="hidden peer" />
                  ...
                  <div className='mr-5 w-64 h-40 items-center flex justify-center'>
                    <input defaultChecked={data && data.isForSell === true ? false : true} {...register("isForSell", { required: "Please select if the property is for sell or rent" })} type="radio" id="isSell-false" name="isForSell" value="false" className="hidden peer" />
              ...
              <div className='flex flex-col'>
                ...
                <div className='flex'>
                  <div className='mr-5 w-64 h-40 items-center flex justify-center'>
                    <input defaultChecked={data && data.developmentType === true ? true : false} {...register("developmentType", { required: "Please select the type of development" })} type="radio" id="house" name="developmentType" value="House" className="hidden peer" />
                  ...
                  <div className='mr-5 w-64 h-40 items-center flex justify-center'>
                    <input defaultChecked={data && data.developmentType === true ? false : true} {...register("developmentType", { required: "Please select the type of development" })} type="radio" id="apartment" name="developmentType" value="Apartment" className="hidden peer" />
            ...
            <div className='w-full mt-10'>
              ...
              <div className='w-full grid grid-cols-9'>
                <div className='col-span-5 w-full flex flex-col border-r-2 border-[#c5c5c5]'>
                  ...
                  <input defaultValue={data && data.title} className='mt-2 w-[90%] p-2 border-red-600 border-2 py-1 px-2 h-10 rounded-xl border-opacity-50 focus:border-opacity-100 outline-none transition-all' type="text" {...register("title", { required: "Title is required", minLength: { value: 2, message: "Title must be at least 2 characters" }, maxLength: { value: 50, message: "Title must be at most 50 characters" } })} />
                  {errors.title && <span className="text-red-600">{errors.title.message}</span>}

                  <label className='text-xl font-semibold mt-5'>Description</label>
                  <textarea defaultValue={data && data.description} className='mt-2 w-[90%] p-2 border-red-600 border-2 py-1 px-2 min-h-[25vh] rounded-xl border-opacity-50 focus:border-opacity-100 outline-none transition-all' type="text" {...register("description", { required: "Description is required", minLength: { value: 10, message: "Description must be at least 10 characters" } })} />
                ...
                <div className='col-span-4 w-full pl-5'>
                  <div className='w-full grid grid-cols-2 gap-4'>
                    <div className='w-full flex flex-col'>
                      ...
                      <input defaultValue={data && data.price} type="number" className='mt-2 p-2 border-red-600 border-2 py-1 px-2 h-10 rounded-xl border-opacity-50 focus:border-opacity-100 outline-none transition-all' {...register("price", { required: "Price is required" })} />
                      {errors.price && <span className="text-red-600">{errors.price.message}</span>}
                    </div>
                    <div className='w-full flex flex-col'>
                      <label className='text-xl font-semibold'>Area</label>
                      <input defaultValue={data && data.area} type="number" className='mt-2 p-2 border-red-600 border-2 py-1 px-2 h-10 rounded-xl border-opacity-50 focus:border-opacity-100 outline-none transition-all' {...register("area", { required: "Area is required", min: { value: 16, message: "Area must be at least 16" } })} />
                  ...
                  <div className='w-full grid grid-cols-3 gap-4 mt-10'>
                    <div className='w-full flex flex-col'>
                      ...
                      <input defaultValue={data && data.roomQuantity} type="number" className='mt-2 p-2 border-red-600 border-2 py-1 px-2 h-10 rounded-xl border-opacity-50 focus:border-opacity-100 outline-none transition-all' {...register("roomQuantity", { required: "Room quantity is required", min: { value: 1, message: "Room quantity must be at least 1" } })} />
                    ...
                    <div className='w-full flex flex-col'>
                      ...
                      <input defaultValue={data && data.floor} type="number" className='mt-2 p-2 border-red-600 border-2 py-1 px-2 h-10 rounded-xl border-opacity-50 focus:border-opacity-100 outline-none transition-all' {...register("floor", { required: "Floor is required", min: { value: 0, message: "Floor must be at least 0" } })} />
                    ...
                    <div className='w-full flex flex-col'>
                      ...
                      <input defaultValue={data && data.floorQuantity} type="number" className='mt-2 p-2 border-red-600 border-2 py-1 px-2 h-10 rounded-xl border-opacity-50 focus:border-opacity-100 outline-none transition-all' {...register("floorQuantity", { required: "Floor quantity is required", min: { value: 1, message: "Floor quantity must be at least 1" }, max: { value: 100, message: "Floor quantity must be at most 100" } })} />
                  ...
                  <div className='w-full grid grid-cols-2 gap-4 mt-10'>
                    <div className='w-full flex flex-col'>
                      ...
                      <input defaultValue={data && data.city} type="text" className='mt-2 p-2 border-red-600 border-2 py-1 px-2 h-10 rounded-xl border-opacity-50 focus:border-opacity-100 outline-none transition-all' {...register("city", { required: "City is required", minLength: { value: 3, message: "City must be at least 3 characters" }, maxLength: { value: 100, message: "City must be at most 100 characters" } })} />
                      {errors.city && <span className="text-red-600">{errors.city.message}</span>}
                    </div>
                    <div className='w-full flex flex-col'>
                      <label className='text-xl font-semibold'>Address</label>
                      <input defaultValue={data && data.address} type="text" className='mt-2 p-2 border-red-600 border-2 py-1 px-2 h-10 rounded-xl border-opacity-50 focus:border-opacity-100 outline-none transition-all' {...register("address", { required: "Address is required", minLength: { value: 3, message: "Address must be at least 3 characters" } })} />
              ...
              <div className='w-full grid grid-cols-5 gap-4'>
                {[...Array(5)].map((_, index) => (
                  ...
                  >
                    ...
                    {selectedFiles[index] ? (
                      <img
                        src={`data:image/jpeg;base64,${selectedFiles[index].image}`}
                        alt={`Image ${index}`}
            ...
            <div className='w-full mt-10 flex flex-col justify-center items-center'>
              <input className='border-red-600 border-2 py-2 px-10 rounded-xl text-xl font-semibold cursor-pointer hover:bg-red-600 hover:text-white transition-all' type="submit" value={"Edit advertisement"} />
            </div>
          </form>
        </div>
      </div>
